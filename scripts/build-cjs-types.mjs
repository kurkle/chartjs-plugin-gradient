 ...
 * `export default` as needing an extra `.default` access at runtime, which
 * would fail (attw's FalseExportDefault). The require condition therefore gets
 * its own `.d.cts` copies, with `export default` rewritten to `export =` and
 * relative specifiers pointed at their `.cjs` counterparts.
 */
